...
def train_model(filter_df, coin, date_reference, targe_value = 0.02, period=14400, window_model = 400):
    ...
    clean_df = filter_df.dropna().loc[(filter_df['slope'] > 0) & (filter_df['slope_short'] > 0)].drop(drop_columns,
                                                                                             axis=1)
    print(coin)
