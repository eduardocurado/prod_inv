...
curl 'http://localhost:5000/get_historical_tickers?period=14400&historical=400'
echo Got Historical Data 14400!

curl 'http://localhost:5000/get_historical_google_trends?period=14400&historical=400'
echo Got Google Trends

curl 'http://localhost:5000/get_historical_tas?period=86400&historical=400'
